...
class CoupledDEVS(BaseDEVS):
    ...
    def __init__(self, name=None):
        ...
        self.component_set = []
        # This should be initialized in the Concrete Coupled to enable free choice of the underlying data structure.
    ...
    def getContextInformation(self, property, *args, **kwargs):
        """
        Return context information for a given property within the children state space.
        :param property:
        :return:
        """
        pass
