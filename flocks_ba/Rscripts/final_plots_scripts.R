...
flocks.vanilla = read_csv("~/proj/crazydevs/pythonpdevs/examples/flocks/results/historial_flocks_g70_r5_d1.5_ac-1_septurn0.03_alignturn0.09_cohturn0.06_supercohere-1.00.csv") # Excelente
flocks.ba = read_csv("~/proj/crazydevs/pythonpdevs/examples/flocks/results/historial_flocks_g70_r5_d1.5_ac-1_septurn0.03_alignturn0.09_cohturn0.06_supercohere25.00.csv") # Excelente
flocks.fa = read_csv("~/proj/crazydevs/pythonpdevs/examples/flocks/results/historial_flocks_g70_r5_d1.5_ac20_septurn0.03_alignturn0.09_cohturn0.06_supercohere-1.00.csv") # Excelente
flocks.vanilla$t = flocks.vanilla$t + 1.5
flocks.ba$t = flocks.ba$t + 1.5
flocks.fa$t = flocks.fa$t + 1.5
